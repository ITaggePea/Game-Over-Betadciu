...
--         noteTweenX("nota8", 3, 510, 0.5, cubeInOut)
    ...
    if curStep == 1984 then
        fadeCamPsych('hud', '0xff000000', 1, true, true)
        changeStage('churchruv')
        changeDadAuto('ruv')
        changeGFAuto('nogf')
        changeBFAuto('sarvente')
    end
    ...
    if curStep == 2048 then
        fadeCamPsych('hud', '0xff000000', 1, true, true)
        changeStage('DayBurnNightRoof')
        changeDadAuto('LiquidAnnienight')
        changeGFAuto('emptygf')
        changeBFAuto('sarvente')

         setProperty('boyfriend.doMissThing', false)
         setProperty('boyfriend.stopIdle', false)
         setProperty('boyfriend.color', RGBColor(166,166,166,166))
    end
...
function bfNoteHit(note, isSustain, noteType)
